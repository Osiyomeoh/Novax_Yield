          ...
          content: (
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-blue-500 pl-6">
                  <h3 className="text-xl font-semibold mb-3">Step 2: Connect to Arbitrum Sepolia</h3>
                  <p className="text-gray-600 mb-4">
                    Connect to Arbitrum Sepolia (automatic via Privy):
                  </p>
                  <div className="bg-gray-50 p-4 rounded-lg font-mono text-sm">
                    <div className="mb-2"><strong>Network Name:</strong> Arbitrum Sepolia</div>
                    <div className="mb-2"><strong>RPC URL:</strong> https://sepolia-rollup.arbitrum.io/rpc</div>
                    <div className="mb-2"><strong>Chain ID:</strong> 421614</div>
                    <div className="mb-2"><strong>Currency Symbol:</strong> ETH</div>
                    <div><strong>Block Explorer:</strong> https://sepolia.arbiscan.io</div>
                  </div>
                </div>
      ...
      subsections: [
        {
          ...
          content: (
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Transform your real-world assets and trade receivables into tradeable digital tokens on the Arbitrum blockchain. 
                ...
                <div className="border rounded-lg p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 text-gray-600">
                        <li>Your asset receives a unique token ID on Arbitrum</li>
                ...
                <div className="border rounded-lg p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 text-gray-600">
                        <li>Pool tokens are created as ERC-20 tokens on Arbitrum</li>
      ...
      subsections: [
        {
          ...
          content: (
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Novax Yield is built on Arbitrum's EVM-compatible blockchain infrastructure, 
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-6">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-gray-600">
                    ...
                    <li><strong>Chain ID:</strong> 421614 (Arbitrum Sepolia Testnet)</li>
                    <li><strong>Gas Fees:</strong> Low transaction costs</li>
                    <li><strong>Finality:</strong> Fast block confirmation</li>
                    <li><strong>Explorer:</strong> <a href="https://sepolia.arbiscan.io" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">sepolia.arbiscan.io</a></li>
                  </ul>
                </div>
          ...
          content: (
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="border rounded-lg p-6">
                  <h3 className="text-xl font-semibold mb-3">Why Arbitrum Network?</h3>
                  <p className="text-gray-600 mb-3">
                    Arbitrum offers several advantages:
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-gray-600">
                ...
                <div className="border rounded-lg p-6">
                  <h3 className="text-xl font-semibold mb-3">How do I get ETH?</h3>
                  <p className="text-gray-600 mb-3">
                    For mainnet: Purchase ETH on exchanges or bridge from other networks to Arbitrum.
                  </p>
                  <p className="text-gray-600">
                ...
                <div className="border rounded-lg p-6">
                  ...
                  <ul className="space-y-2 text-gray-600">
                    <li><strong>Arbitrum Network:</strong> Low transaction costs</li>
                ...
                <div className="border rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    Yes. Metadata is stored on decentralized IPFS, transactions are immutable on Arbitrum, 
