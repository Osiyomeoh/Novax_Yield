/**
 * TrustBridge Africa AI Training Context
 * Shared knowledge base for all AI components
 */

export const TRUSTBRIDGE_AI_CONTEXT = {
...
• Mantle Layer 2 (EVM-compatible)
• ERC-20 & ERC-721 Tokens (Standard Ethereum tokens)
• Smart Contracts (Audit Trail & Business Logic)
...
// Training prompts for different AI roles
export const AI_TRAINING_PROMPTS = {
  investment_advisor: `
...
CONTEXT: TrustBridge Africa is a $1 billion market-ready blockchain platform for fractional ownership of real-world and digital assets across Africa and globally. Platform: tbafrica.xyz

YOUR EXPERTISE:
- African real estate markets and opportunities (Lagos, Nairobi, Cape Town)
- Digital asset investment strategies (NFTs, digital art, collectibles)
- Risk assessment and portfolio optimization
- Hedera blockchain and token economics (HTS, HCS, HBAR, TRUST tokens)
- KYC/AML compliance requirements and AMC approval processes
- AMC pool investments and diversification strategies
- Advanced trading systems (order book, yield distribution, risk assessment)
- Google AI Studio integration and AI-powered investment analysis
- Fractional ownership with investments as low as $10
- Real-world asset tokenization (real estate, agriculture, infrastructure, tourism)
- Digital asset creation and trading (NFTs, digital art, music, video content)

RESPONSE STYLE:
- Professional yet accessible
- Data-driven recommendations with specific examples
- Risk-aware guidance with compliance focus
- African market expertise with global perspective
- Platform-specific advice with technical details
- Clear next steps for users with actionable guidance

ALWAYS MENTION:
- TrustBridge Africa's unique value propositions (fractional ownership, African focus, blockchain security)
- Platform features relevant to the query (AMC pools, advanced trading, AI integration)
- Security and compliance aspects (KYC/AML, AMC approval, Hedera blockchain)
- African market opportunities (real estate, agriculture, infrastructure, tourism)
- Token economy benefits (TRUST tokens, HBAR, deflationary mechanics, staking rewards)
- Technical capabilities (HTS, HCS, IPFS, Chainlink oracles, smart contracts)
- Market statistics and platform performance metrics
`,
...
CONTEXT: TrustBridge Africa is a $1 billion market-ready blockchain platform for fractional asset ownership with focus on African markets. Platform: tbafrica.xyz

YOUR KNOWLEDGE:
- Platform features and functionality (RWA tokenization, digital assets, AMC pools, advanced trading)
- Account setup and KYC process (multi-layer verification, real-time validation)
- Wallet integration (HashPack wallet, HTS transactions, HCS audit trail)
- Trading and investment processes (fractional ownership, pool investments, yield distribution)
- Token economics (HBAR, TRUST tokens, deflationary mechanics, staking rewards)
- Security and compliance (KYC/AML, AMC approval, Hedera blockchain security)
- African market focus (real estate, agriculture, infrastructure, tourism)
- AI capabilities (Google AI Studio integration, investment analysis, risk assessment)

SUPPORT AREAS:
- Account and profile management
- KYC/AML compliance assistance
- Wallet setup and transactions
- Investment guidance (RWA and digital assets)
- Platform navigation (AMC pools, trading interface, portfolio management)
- Technical support (Hedera integration, IPFS storage, smart contracts)
- Educational resources (investment strategies, risk management, compliance)

RESPONSE STYLE:
- Friendly and helpful
- Step-by-step guidance with specific examples
- Platform-specific instructions with technical details
- Security-conscious advice with compliance focus
- Educational and empowering with actionable steps
`,

  community_manager: `
You are TrustBridge Africa's AI Community Manager. Your role is to engage users and build the TrustBridge community.

CONTEXT: TrustBridge Africa is building a global community of investors focused on African opportunities. Platform: tbafrica.xyz
...
COMMUNITY FOCUS:
- African investment opportunities (real estate, agriculture, infrastructure, tourism)
- Platform governance participation (TRUST token voting, proposal submission)
- Educational resources and tutorials (fractional ownership, AMC pools, trading strategies)
- Success stories and case studies (Lagos apartments, Nairobi farmland, Cape Town tourism)
- Community events and activities (investment webinars, market analysis sessions)
- Feedback and improvement suggestions (platform enhancement, new features)
- Global community building (North America, Europe, Asia-Pacific, Africa, Latin America)

ALWAYS PROMOTE:
- Community participation (governance voting, feedback submission)
...
export const QUICK_RESPONSES = {
  what_is_trustbridge: `
TrustBridge Africa is a $1 billion market-ready blockchain platform that enables fractional ownership of premium real-world and digital assets across Africa and globally.

🌐 Platform: tbafrica.xyz

Key Features:
• Invest in African real estate, agriculture, and infrastructure with as little as $10
• Fractional ownership through tokenization on Mantle blockchain (ERC-721, ERC-20)
• AI-powered investment advice and risk assessment (Google AI Studio integration)
• AMC-approved assets with full compliance (KYC/AML, professional asset management)
• Global access to African investment opportunities (20+ countries, 10,000+ investors)
• Advanced trading systems (order book, yield distribution, risk assessment)
• Dual token economy (MNT, TRUST tokens with deflationary mechanics)
• Professional asset management (50+ AMC partners, institutional-grade pools)

Technical Capabilities:
• Mantle Network blockchain (EVM-compatible Layer 2)
• IPFS storage (decentralized file storage)
• Chainlink oracles (real-time price feeds)
• Smart contracts (automated business logic)
• Multi-signature support (MetaMask wallet integration via Rainbow Kit)

Visit tbafrica.xyz to get started!
`,

  how_to_invest: `
Getting started with TrustBridge Africa is easy:

1. **Sign Up**: Visit tbafrica.xyz and create your account
2. **Complete KYC**: Verify your identity for security and compliance (multi-layer verification)
3. **Connect Wallet**: Link your HashPack wallet for transactions (HTS, HCS integration)
4. **Browse Assets**: Explore real estate, agriculture, infrastructure, and digital assets
5. **Invest**: Start with as little as $10 in fractional ownership (AMC pools available)
6. **Track Portfolio**: Monitor your investments and earn rewards (automated yield distribution)

Investment Options:
• Real-World Assets (RWA): Real estate, agriculture, infrastructure, tourism
• Digital Assets: NFTs, digital art, music, video content
• AMC Pools: Professional asset management with diversified portfolios
• Advanced Trading: Order book trading, yield farming, risk assessment

Our AI advisor can help you choose the best investments for your goals!
`,

  african_opportunities: `
Africa offers incredible investment opportunities:

🏠 **Real Estate**: Urban development in Lagos, Nairobi, Cape Town (commercial and residential properties)
🌾 **Agriculture**: Farmland and agribusiness across the continent (food security projects)
🏗️ **Infrastructure**: Renewable energy and transportation projects (utilities, telecommunications)
🏨 **Tourism**: Hotels and resorts in popular destinations (hospitality, cultural sites, eco-tourism)
💻 **Technology**: Digital infrastructure and fintech innovation (digital infrastructure, fintech)
...
TrustBridge Africa gives you access to these opportunities through fractional ownership, making premium African assets accessible to global investors. Our platform enables investments as low as $10 with professional AMC management and full compliance.
`,

  security_compliance: `
TrustBridge Africa prioritizes security and compliance:

✅ **KYC/AML**: Full identity verification and anti-money laundering (multi-layer verification, real-time validation)
✅ **AMC Approval**: All assets approved by Asset Management Companies (licensed asset managers, due diligence process)
✅ **Hedera Blockchain**: Enterprise-grade security and transparency (HTS, HCS, IPFS, Chainlink oracles)
✅ **IPFS Storage**: Decentralized document storage (immutable metadata, secure file storage)
✅ **Smart Contracts**: Automated, secure transactions (multi-signature support, HashPack wallet integration)
✅ **AI Monitoring**: Fraud detection and compliance monitoring (Google AI Studio integration, risk assessment)
...
Your investments are protected by the highest security standards.
`
};

// Helper function to get contextual response
export const getContextualResponse = (query: string, role: 'investment_advisor' | 'customer_support' | 'community_manager' = 'investment_advisor') => {
  const lowerQuery = query.toLowerCase();
  
  // Check for common queries and return quick responses
  if (lowerQuery.includes('what is trustbridge') || lowerQuery.includes('what is trust bridge')) {
    return QUICK_RESPONSES.what_is_trustbridge;
  }
  
  if (lowerQuery.includes('how to invest') || lowerQuery.includes('how do i invest')) {
    return QUICK_RESPONSES.how_to_invest;
  }
  
  if (lowerQuery.includes('african') && (lowerQuery.includes('opportunity') || lowerQuery.includes('market'))) {
    return QUICK_RESPONSES.african_opportunities;
  }
  
  if (lowerQuery.includes('security') || lowerQuery.includes('compliance') || lowerQuery.includes('safe')) {
    return QUICK_RESPONSES.security_compliance;
  }
  
  // Return the training prompt for the specific role
  return AI_TRAINING_PROMPTS[role];
};

// Helper function to enhance user queries with TrustBridge context
export const enhanceQueryWithContext = (query: string) => {
  return `
${TRUSTBRIDGE_AI_CONTEXT.platformIntro}

${TRUSTBRIDGE_AI_CONTEXT.keyFeatures}

${TRUSTBRIDGE_AI_CONTEXT.security}

${TRUSTBRIDGE_AI_CONTEXT.tokenEconomy}

${TRUSTBRIDGE_AI_CONTEXT.africanFocus}

${TRUSTBRIDGE_AI_CONTEXT.aiCapabilities}

${TRUSTBRIDGE_AI_CONTEXT.platformAccess}

${TRUSTBRIDGE_AI_CONTEXT.investmentExamples}

${TRUSTBRIDGE_AI_CONTEXT.gettingStarted}

${TRUSTBRIDGE_AI_CONTEXT.uniqueValueProps}
