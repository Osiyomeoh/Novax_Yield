 ...
 * 
 * Usage:
 *   USER_ADDRESS=0x... npx hardhat run scripts/get-user-assets.js --network mantle_testnet
 * 
 * Or set USER_ADDRESS in .env file
 * If no address is provided, uses deployer address
 */
...
async function main() {
  ...
  // Usage: USER_ADDRESS=0x... npx hardhat run scripts/get-user-assets.js --network mantle_testnet
  const userAddress = process.env.USER_ADDRESS || null;
